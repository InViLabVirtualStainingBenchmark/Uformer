#!/bin/bash
#SBATCH --job-name=uformer_MIST_PR_leib_512_p2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/uformer_MIST_PR_512_24ep_leibniz_p2_leib_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/uformer_MIST_PR_512_24ep_leibniz_p2_leib_%j.err
