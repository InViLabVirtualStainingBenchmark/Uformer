#!/bin/bash
#SBATCH --job-name=uformer_MIST_HER2_512_p2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/uformer_MIST_HER2_512_24ep_p2_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/uformer_MIST_HER2_512_24ep_p2_%j.err
