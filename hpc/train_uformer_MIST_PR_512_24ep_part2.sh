#!/bin/bash
#SBATCH --job-name=uformer_MIST_PR_512_p2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/uformer_MIST_PR_512_24ep_p2_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/uformer_MIST_PR_512_24ep_p2_%j.err
...
OUTPUT_DIR="$VSC_DATA/projects/outputs/uformer_MIST_PR_512_24ep"
CHECKPOINT="/output/checkpoints/denoising/MIST_PR/Uformer_B_512_24ep/models/model_latest.pth"
...
srun apptainer exec \
    ...
    bash /code/hpc/train_uformer_MIST_PR.sh 24 --resume $CHECKPOINT
    "
