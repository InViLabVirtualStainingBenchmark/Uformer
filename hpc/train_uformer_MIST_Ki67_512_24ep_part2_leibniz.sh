#!/bin/bash
#SBATCH --job-name=uformer_MIST_Ki67_leib_512_p2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/uformer_MIST_Ki67_512_24ep_leibniz_p2_leib_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/uformer_MIST_Ki67_512_24ep_leibniz_p2_leib_%j.err
...
OUTPUT_DIR="$VSC_DATA/projects/outputs/uformer_MIST_Ki67_512_24ep_leibniz"
CHECKPOINT="/output/checkpoints/denoising/MIST_Ki67/Uformer_B_512_24ep/models/model_latest.pth"
...
srun apptainer exec \
    ...
    bash /code/hpc/train_uformer_MIST_Ki67.sh 24 --resume $CHECKPOINT
    "
