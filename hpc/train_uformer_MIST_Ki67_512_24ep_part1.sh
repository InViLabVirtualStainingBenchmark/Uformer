#!/bin/bash
#SBATCH --job-name=uformer_MIST_Ki67_512_p1
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -o /data/antwerpen/212/vsc21216/projects/logs/uformer_MIST_Ki67_512_24ep_p1_%j.out
#SBATCH -e /data/antwerpen/212/vsc21216/projects/logs/uformer_MIST_Ki67_512_24ep_p1_%j.err
